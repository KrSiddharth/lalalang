const laLaLangStories = [
    {
        ...
        text: `Il était une fois une petite fille de village, la plus jolie qu'on eût su voir: sa mère en était folle, et sa mère-grand plus folle encore. Cette bonne femme lui fit faire un petit chaperon rouge qui lui seyait si bien, que partout on l'appelait le Petit Chaperon Rouge.
    ...
    },
    {
        ...
        text: `Un meunier ne laissa pour tous biens, à trois enfants qu'il avait, que son moulin, son âne et son chat. Les partages furent bientôt faits: ni le notaire ni le procureur n'y furent point appelés, ils auraient eu bientôt mangé tout le pauvre patrimoine.
    ...
    Lorsque le Chat eut ce qu'il avait demandé, il se botta bravement; et, mettant son sac à son cou, il en prit les cordons avec ses deux pattes de devant, et s'en alla dans une garenne où il y avait grand nombre de lapins.
    ...
    --Voilà, sire, un lapin de garenne que M. le marquis de Carabas (c'était le nom qu'il prit en gré de donner à son maître) m'a chargé de vous présenter de sa part.
    ...
    Pendant qu'on retirait le pauvre marquis de la rivière, le Chat, s'approchant du carrosse, dit au roi que, dans le temps que son maître se baignait, il était venu des voleurs qui avaient emporté ses habits, quoiqu'il eût crié au voleur de toute sa force; le drôle les avait cachés sous une grosse pierre.
    
    Le roi ordonna aussitôt aux officiers de sa garde-robe d'aller quérir un de ses plus beaux habits pour M. le marquis de Carabas.
    ...
    Le Chat, qui entendit le bruit du carrosse qui passait sur le pont-levis du château, courut au-devant, et dit au roi:
    ...
    },
    {
        ...
        title: "CENDRILLON",
        imgUrl:
            "https://th.bing.com/th/id/OIG.gSzBDzHlEzKmTM8lkVpI?w=1024&h=1024&rs=1&pid=ImgDetMain",
